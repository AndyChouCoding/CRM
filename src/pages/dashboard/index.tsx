                ...
                <div className="p-2 w-[300px] h-[200px] border-[1px] border-black rounded-xl">
                    <div className="flex justify-between items-center p-1">
                        ...
                        <div className="text-center">
                            <div>User</div>
                            <div className=" bg-purple-500 text-white p-2 rounded-xl">職位</div>
                        </div>
                    </div>
                    <div className=" border-[1px] border-black"></div>
                    <div className=" p-2">
                        <div><a href="">負責帳號</a></div>
                        <div><a href="">全部帳號</a></div>
                        <div><a href="">負責標籤</a></div>
                        <div><a href="">無參與分配</a></div>
                    </div>
                </div>
                {/* 代辦事項 */}
                <div className="p-4 w-[300px] h-[200px] border-[1px] border-black rounded-xl">
